...
export default function App() {
  const steps = [
    ...
    { id: 4, text: "Claim your Pandora gift card" },
  ];
    ...
    <>
      <div className="hidden md:flex min-h-screen bg-[#f8f9fa] flex-col items-center justify-center p-6 font-sans">
        ...
        <p className="text-[#64748b] max-w-[480px] text-[16px] leading-[1.6] text-center font-medium">
          This exclusive <strong className="text-[#334155] font-bold">Pandora</strong> member reward is only accessible on mobile devices. Please open this site on your smartphone to continue.
        </p>
      </div>

      <div className="md:hidden min-h-screen bg-[#f4f6f8] flex flex-col font-sans">
        {/* Top Banner */}
        <div className="w-full bg-[#f6d7df] text-slate-800 py-[6px] px-4 flex justify-center items-center shadow-sm flex-none">
        ...
        <div className="w-full max-w-[400px] mx-auto flex flex-col py-6 px-5">
          ...
          <div className="mb-8 w-full text-center">
            <div className="flex justify-center items-center mb-4 mt-2">
              <div className="flex flex-col items-center justify-center">
                <div className="flex items-center justify-center mb-2">
                  <span className="text-black text-[32px] leading-[1] tracking-[3px]" style={{ fontFamily: 'sans-serif', fontWeight: 'bold' }}>
                    PANDORA
                  </span>
                </div>
              </div>
            ...
            <h1 className="text-[28px] font-extrabold tracking-tight text-black leading-tight flex flex-col items-center">
              <span>$500 Pandora</span>
          ...
          <div className="w-full bg-white rounded-[20px] border border-slate-200 shadow-sm overflow-hidden mb-8">
            <ul className="flex flex-col">
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-[28px] h-[28px] rounded-full bg-[#e2a1b1] text-black flex items-center justify-center font-bold text-[13px] select-none">
                    {step.id}
                  </div>
          ...
          <div className="w-full flex flex-col items-center mb-8">
            <button 
              onClick={() => {
                const url = 'https://giftclick.org/aff_c?offer_id=4070&aff_id=144760';
                window.location.href = url;
              }}
              className="block w-full text-center bg-[#e2a1b1] hover:bg-[#d18799] text-black font-bold text-[22px] py-[16px] rounded-[10px] transition-all duration-200 shadow-[0_15px_30px_-5px_rgba(226,161,177,0.5)] cursor-pointer select-none"
            >
              Claim Your Reward
            </button>
            ...
            <p className="mt-3 text-[13px] text-[#78828e] text-center leading-[1.6]">
              To qualify for your Pandora gift card, you'll need to complete 3-5 required deals to unlock the full $500 reward. Be sure to finish each deal from start to completion. Once all required deals are successfully completed, you'll be eligible to claim your reward.
            </p>
